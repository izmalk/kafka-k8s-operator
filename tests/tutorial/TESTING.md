...
```bash
git clone <repo-url> && cd kafka-k8s-operator
...
```
2026-05-07 20:13:23 Debug shell on multipass:ubuntu-24.04-64 for multipass:ubuntu-24.04-64:tests/tutorial/deploy
2026-05-07 20:13:23   Address: 10.189.154.39:22
2026-05-07 20:13:23   User:    root
2026-05-07 20:13:23   Password: 6d11d3739e023950
```
...
cd /charmed-kafka-k8s
juju status                 # inspect the model
bash tests/tutorial/deploy.sh   # re-run the failing script
```
...
# Run a single stage:
spread -abend -vv -debug multipass:ubuntu-24.04-64:tests/tutorial/deploy
```
...
|-------------------|---------|------------------------|
| `SPREAD_VM_CPUS`  | `4`     | Multipass VM CPU count |
| `SPREAD_VM_MEM`   | `8G`    | Multipass VM RAM       |
